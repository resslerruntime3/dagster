...
from typing import Any, Generator, Mapping, NamedTuple, Optional, Sequence, TypeVar, cast
...
default_mode_def_for_test = ModeDefinition(
    resource_defs={"io_manager": cast(ResourceDefinition, fs_io_manager)}
)
